...
#include </home/js/catkin_ws/src/robot_localization/include/robot_localization/navsat_conversions.h>
...
int main(int argc, char** argv)
{
    ...
    ros::Publisher pubWaypointNodeEnded = n.advertise<std_msgs::Bool>("/gps_waypoint_nav/waypoint_following_status", 1000);
    ...
    ros::Subscriber sub_odom = n.subscribe("/gps_waypoint_nav/odometry/filtered_map", 1000, odometry_CB);
    ...
    ros::param::get("/gps_waypoint_nav/goalTolerance", goal_tolerance);
